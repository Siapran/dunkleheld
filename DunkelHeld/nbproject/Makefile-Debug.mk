...
${OBJECTDIR}/_ext/939751984/Game.o: /home/siapran/Programming/C++/SFML/Donker\ Held/src/Game.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include `pkg-config --cflags sfml-all` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/939751984/Game.o /home/siapran/Programming/C++/SFML/Donker\ Held/src/Game.cpp
...
${OBJECTDIR}/src/Frame.o: src/Frame.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include `pkg-config --cflags sfml-all` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Frame.o src/Frame.cpp
